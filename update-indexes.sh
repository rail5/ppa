...
function create_gnu_index ()
{
    ...
    (
        ...
        echo "<html><head><title>Index of https://${DOMAIN}${URLPATH}</title><style> a:link { color: #78b6fc; } a:visited { color: #557cc8; } body { background-color: #181818; color: #bbbbbb; }</style></head>";
